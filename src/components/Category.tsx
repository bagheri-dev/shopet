        ...
        <div className={"container mx-auto"}>
            <div className={"flex justify-between gap-x-5"}>
                <div
                    ...
                    <div className={"flex justify-start z-20"}><img src={"/public/images/category/category4.png"}
                ...
                <div
                    ...
                    <div className={"flex justify-start z-20"}><img src={"/public/images/category/category3.png"}
                                                                    alt={"فروش انواع غذای خشک"}/></div>
                </div>
                <div
                    ...
                    <div className={"flex justify-start z-20"}><img src={"/public/images/category/category2.png"}
                                                                    alt={"فروش انواع غذای خشک"}/></div>
                </div>
                <div
                    ...
                    <div className={"flex justify-start z-20"}><img src={"/public/images/category/category1.png"}
                                                                    alt={"فروش انواع غذای خشک"}/></div>
                </div>
            </div>
        </div>
